$(document).ready(function() {
  ...
  function clickedSubmit() {
    ...
    // ⬇ If input fields are blank, do not let them submit.
    if (($('#firstNameInput').val() === "") || ($('#lastNameInput').val() === "") || ($('#idInput').val() === "") || ($('#titleInput').val() === "") || ($('#salaryInput').val() === "")) {
      ...
      totalSalary += Number(salaryInput); // .val() always returns a string. 
      monthlyCosts = parseInt(totalSalary / 12); // Making sure it's a whole number. 
